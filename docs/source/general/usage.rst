...
Metadata is queried from an SQLite database created by :class:`pyroSAR.archive.Archive`.
...
All scenes found are then inserted into ``db_file`` using method :meth:`pyroSAR.archive.Archive.insert`.
