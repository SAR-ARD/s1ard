...
def product_xml(meta, target, assets, nsmap, ard_ns, exist_ok=False):
    ...
    if meta['prod']['windNormBackscatterMeasurement'] is not None:
        ...
        windNormReferenceModel = etree.SubElement(processingInformation,
                                                  _nsc('_:windNormReferenceModel', nsmap, ard_ns=ard_ns))
        windNormReferenceModel.text = meta['prod']['windNormReferenceModel']
