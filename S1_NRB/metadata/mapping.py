...
RES_MAP = {'IW': {'STAC': {'azimuthResolution': '22.7',
                           'rangeResolution': '3.5'},
                  'XML': {'azimuthResolution': {'IW1': '22.5',
                                                'IW2': '22.7',
                                                'IW3': '22.6'},
           ...
           'EW': {'STAC': {'azimuthResolution': '45.6',
                           'rangeResolution': '14.4'},
                  'XML': {'azimuthResolution': {'EW1': '43.7',
                                                'EW2': '44.3',
                                                'EW3': '45.2',
                                                'EW4': '45.6',
                                                'EW5': '44.0'},
           ...
           'SM': {'STAC': {'azimuthResolution': '4.9',
                           'rangeResolution': '3.6'},
                  'XML': {'azimuthResolution': {'S1': '4.9',
                                                'S2': '4.9',
                                                'S3': '4.9',
                                                'S4': '4.9',
                                                'S5': '3.9',
